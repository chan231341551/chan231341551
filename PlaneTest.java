...
public class PlaneTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("최대 승객수: "+plane3.getMaxNumberOfPasssengers());
		System.out.println();
